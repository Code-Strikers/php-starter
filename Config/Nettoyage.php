<?php  
	...
	Class Nettoyage{
		...
		/* Function qui retourne le chemin absolu d'une photo d'un personnage passé en paramètre */
		public static function CreateCheminPhotoPersonnage($nomPhoto){
		
			if(isset($nomPhoto) && !empty($nomPhoto)){
				return "./Vue/Image/".$nomPhoto;
			} else { return "./Vue/Image/Inconnu.jpg"; }
		}
		...
		*/
		...
		public static function ExtractNomPhotoFromPathPerso($chaine){

			if(isset($chaine)){
				return substr($chaine, 12);
			}
		}
	}
?>